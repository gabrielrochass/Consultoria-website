            ...
            <div className="container">
                <div className="custom-card">
                    <div className="img-box">
                        <img src={require('../../assets/solange3.jpeg')} alt="Consultoria em gestão empresarial" />
                    </div>
                ...
                <div className="custom-card">
                    <div className="img-box">
                    <img src={require('../../assets/limp_predial.jpeg')} alt="Limpeza Predial" />
                    </div>
                    <div className="custom-content">
                ...
                <div className="custom-card">
                    <div className="img-box">
                    <img src={require('../../assets/porteiro.jpeg')} alt="Manutenção Predial" />
                    </div>
                    <div className="custom-content">
                        <h2>Recepção</h2>
                ...
                <div className="custom-card">
                    <div className="img-box">
                        <img src={require('../../assets/hosp.jpeg')} alt="Limpeza Hospitalar" />
                    </div>
                    <div className="custom-content">
                ...
                <div className="custom-card">
                    <div className="img-box">
                        <img src={require('../../assets/esp2.jpeg')} alt="Serviços Especializados" />
                    </div>
                    <div className="custom-content">
